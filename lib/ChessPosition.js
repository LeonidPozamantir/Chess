class ChessPosition {
    ...
    isMoveLegal(move) {
        ...
        return this.legalMoves.some(lm => lm.fromX === move.fromX && lm.fromY === move.fromY && lm.toX === move.toX && lm.toY === move.toY);
    }
    ...
    buildLegalMoves() {
        ...
        console.log('#moves: ', this.legalMoves.length);
    }
...
if (typeof module !== 'undefined' && module.exports) {
    console.log('imported in back');
    module.exports = ChessPosition;
} else {
    console.log('imported in front');
